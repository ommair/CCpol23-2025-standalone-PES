...
contains
  ...
  subroutine start
    ...
    integer :: i,j,is,js,k,m,ics,is3,nlin0,ii3,ii,iis,nclus
...
!    call read_geo              !  reads only atomic corrds 
   ...
   write(*,*) '**** CCpol23+ (2025) ****' 
   write(*,*) '**** kcal/mol ****'
   write(*,'(A15,A25,A28,A28,A28)') 'Ravg ','U0 ', 'NB(ind) ', '3B(Fs3) ', 'U0+3B+NB(ind) '
...
!    write(*,*) ii
    write(*,*) Ravg3b, vdwpe, indpe, fs3pe, vdwpe+indpe+fs3pe
